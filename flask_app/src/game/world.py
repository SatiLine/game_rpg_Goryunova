...
LOCATIONS: dict[str, dict[str, object]] = {
    "таверна": {
        "description": "Шумный зал с очагом.",
        "connected_to": ["рыночная площадь", "улица"],
    },
    "кузница": {
        "description": "Жарко. Звон молота о наковальню.",
        "connected_to": ["рыночная площадь"],
    },
    "рыночная площадь": {
        "description": "Центр города. Торговцы, шум.",
        "connected_to": ["таверна", "кузница", "лавка торговца", "улица"],
    },
...
class World:
    ...
    def get_context(self) -> dict[str, object]:
        return {
            "hour": self.hour,
            "day": self.day,
            "time": f"{self.hour:02d}:00, {self.time_of_day()}, день {self.day}",
        }
